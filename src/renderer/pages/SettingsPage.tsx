    ...
    const handleAddToList = (key: ArrayConfigKeys, value: string) => {
        if (value.trim()) {
            ...
            setForm({
                ...
                riskyProvider:
                    key === 'riskyProviders' ? '' : form.riskyProvider,
                trustedIP: key === 'trustedIPs' ? '' : form.trustedIP,
                trustedProcess:
                    key === 'trustedProcesses' ? '' : form.trustedProcess,
            });
        }
    };
        ...
        <div className={styles.container}>
            ...
            <section className={styles.section}>
                ...
                <div className={styles.inputGroup}>
                    ...
                    <button
                        onClick={() =>
                            handleAddToList('bannedIPs', form.bannedIP)
                        }
                    >
                        {t('add')}
                    </button>
                ...
                <ul className={styles.list}>
                    {config.bannedIPs.map(ip => (
                        <li key={ip}>
                            ...
                            <button
                                onClick={() =>
                                    handleRemoveFromList('bannedIPs', ip)
                                }
                            >
                                {t('remove')}
                            </button>
                    ...
                    {ALL_COUNTRIES.map(country => (
                        <li key={country}>
                            <label>
                                <input
                                    type="checkbox"
                                    checked={config.riskyCountries.includes(
                                        country
                                    )}
                                    onChange={() =>
            ...
            <section className={styles.section}>
                ...
                <div className={styles.inputGroup}>
                    ...
                    <button
                        onClick={() =>
                            handleAddToList('trustedIPs', form.trustedIP)
                        }
                    >
                        {t('add')}
                    </button>
                ...
                <ul className={styles.list}>
                    {config.trustedIPs.map(ip => (
                        <li key={ip}>
                            ...
                            <button
                                onClick={() =>
                                    handleRemoveFromList('trustedIPs', ip)
                                }
                            >
                                {t('remove')}
                            </button>
